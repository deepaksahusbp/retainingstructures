...
<!-- ---------------------------------Navbar Header Closed------------------------------------------- -->
            <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 3%;">
                        <li class="disabled"><a href="signup.php" class="btn disabled"><span class="glyphicon glyphicon-log-in"></span> Signin</a></li>
                        <li class="disabled"><a href="login.php" class="btn"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                    </ul>
                </div>
        </div>
</nav>