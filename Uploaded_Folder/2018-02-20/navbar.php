            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                    <ul style="margin-left: 5%;" class="nav navbar-nav">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu">
                                                <a tabindex="1" href="<?php echo $learnjava; ?>learnjava.php" class="btn">JAVA</a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="<?php echo $learnjava;?>learnjava.php" class="btn">Core Java</a></li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li class="disabled"><a href="#">Aptitude</a></li>
                            <li class="disabled"><a href="#">Reasoning</a></li>
                            <li class="disabled"><a href="#">Comprehensive</a></li>
                            <li role="separator" class="divider"></li>
                            <li class="active"><a href="<?php echo $qbank;?>xqbank/programming/number.php">Programming</a></li>
                            <li role="separator" class="divider"></li>
                    ...
                    <ul class="nav navbar-nav navbar-right" style="margin-right: 3%;">
                        ...
                        <li><a href="login.php" class="btn disabled"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                    </ul>
                </div>
        </div>
</nav>