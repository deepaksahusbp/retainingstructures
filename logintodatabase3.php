...
<body onload="document.getElementById('menu-toggle').click()">
    ...
    <div class="container-fluid" style="margin-top: 10px;">
        ...
        <center><img src="images/LogIn%20Head.jpg" width="520px" height="200px" class="img-responsive"></center>
        <br>
        Username:<p id="demo"></p>
        <input type="text" id="id4" onfocus="cleartext1()" name="username" onblur="alfamailuse(4)" onkeydown="saaf(4)" value="Enter your username"/><div id="demo1" class="rang">*invalid username</div>
        <br><br>
        ...
        <br><br>
        <input type="submit" value="Sign In"/><div class="allignment"><a href="#"><u>Forgot Password?</u></a></div>
        <center>or</center>
        <br>
