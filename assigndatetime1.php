...
while($row=mysqli_fetch_array($my)){
    ...
    if($row['USERNAME']==$_SESSION['USERNAME'] && $row['FLAG']==1){
        ...
        <div class="container-fluid" style="display: block; padding-left: 20px; padding-right: 20px; ">    
            <div style="height: auto;" class="row content">
                ...
                <div style=" padding-left: 10px; padding-right: 10px;" class="col-sm-12"> 
                    ...
                    <h1 style="margin-left: 5%; font-family:'sans-serif';color:#5E412F; text-align: center; font-size:400%;">Counterfort Retaining Wall</h1>
...
$sql="
  ...
  $_SESSION["SW"] = $row['SW'];
  $_SESSION["LOH"] = $row['LOH'];
  $_SESSION["Q"] = $row['Q'];
  $_SESSION["LFF2"] = $row['LF'];
  $_SESSION["CD"] = $row['COUNTERD'];
  $_SESSION["FP2"] = $row['P'];
...
?>
      ...
      <tr>
        ...
        <td><?php echo $row['LOH'] ?></td>
        <td><?php echo $row['Q'] ?></td>
        <td><?php echo $row['LF'] ?></td>
        <td><?php echo $row['COUNTERD'] ?></td>
...
$sql="
  ...
  <!-- COUNTERFORT REINFORCEEMEENT SPACING IN TABLE -->
  <div>
  <h2>c/c Spacing in Counterfort</h2>
  <!-- <p>The .table-responsive class creates a responsive table which will scroll horizontally on small devices (under 768px). When viewing on anything larger than 768px wide, there is no difference:</p> -->                    
<!-- <form action="#" method="get"> -->                                                                  
  <div class="table-responsive">          
  <table class="table">
...
$sql="
  ...
  <!-- COUNTERFORT REINFORCEMENT SPACING IN TABLE ENDS -->
