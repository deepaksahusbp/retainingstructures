...
$_SESSION['ACTIVE'] = 0;
$xy=$_GET['tempo'];
$_SESSION['USERNAME'] = $_GET['tempo'];
echo "<script>alert('hii'+$xy)</script>";
?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="document.getElementById('menu-toggle').click()">
    ...
    <div class="container-fluid" style="margin-top: 10px;">
        ...
        <center><img src="images/LogIn%20Head.jpg" width="520px" height="200px"></center>
        <br>
        Username:<p id="demo"></p>
        <!-- <input type="text" value = "<?php echo $xy; ?>" id="id4" onfocus="cleartext1()" name="username" onblur="alfamailuse(4)" onkeydown="saaf(4)"  /><span id="demo1" class="rang"></span> -->
        <input type="text" value = "" id="id4" onfocus="cleartext1()" name="username" onblur="alfamailuse(4)" onkeydown="saaf(4)">
        <span id="demo1" class="rang"></span>
        <br><br>
        Password:<p id="demo"></p>
        <input type="password" id="id5" onfocus="cleartext2()" name="pass" id="id5" onchange="alfamailuse(5)" onkeydown="saaf(5)" value="Enter Password"/><span id="demo2" class="rang">*wrong password</span>
        <br><br>
        <input type="checkbox">Remember Me
        <br><br>
        <input type="submit" value="Sign In"/><span class="allignment"><a href="#"><u>Forgot Password?</u></a></span>
        <center>or</center>
        <br>
        <a href="#"><img src="images/facebook-login-button-png-11.png" width="520px" height="60px" class="img-responsive"></a>
    </fieldset>
                        </form>
