...
<head>
    ...
    <script type="text/javascript">
      ...
      function change5() {
        //alert(123456);
          var txt = "<b>Symbol:<b> μ<br><br><b>Unit:<b> No Unit <br><br>A coefficient of friction is a value that shows the relationship between the force of friction between two objects and the normal reaction between the objects that are involved. <br><br>It is a value that is sometimes used in physics to find an object's normal force or frictional force when other methods are unavailable.";
         document.getElementById("para1").innerHTML = txt;
                ...
                <div class="row">
                        ...
                        <form id="sbc" method="post" class="col6 boxshadow">                                
                            <div class="col-xs-12 form-group">
                              ...
                              <input required="1" value="7.5" id="v1" class="form-control input-sm" type="number"  autofocus>
                            </div>
                            <div class="col-xs-12 form-group">
                            ...
                            <div class="col-xs-12 form-group">
                              ...
                              <span class="error">*</span>
                              <input required="1" value="15" id="v4" onfocus="change3()" class="form-control input-sm" type="number" name="sbc">
                            </div>
                            <div class="col-xs-12 form-group">
                            ...
                            <div class="col-xs-12 form-group">
                              ...
                              <span class="error">*</span>
                              <input required="1" value="0.5" id="v6" onfocus="change5()" class="form-control input-sm" type="number" name="sbc">
                            </div>
                            <div class="col-xs-12 form-group">
                            ...
                            <div class="form-group">
                                <a href="result11.php" onclick="assignvalues(1)" class="btn btn-success" role="button">Next</a>
